...
{ 
    public class AssemblyBaseController : BaseController
    {              
        private readonly IAssemblyService _assemblyService;        

        public AssemblyBaseController(IAssemblyService assemblyService)
        { 
        ...
        public JsonResult SearchServerSide()
        {
            ...
            int totalrowsafterfiltering = _assemblyService.SearchResultsCount(searchParams);
